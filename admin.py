...
class UserAdmin(admin.ModelAdmin):
    save_on_top = True
    list_display = ('name', 'email', 'notify', 'formatted_size', 'formatted_used', 'cache_disk', 'cache_path')
    fields = ('name', 'email', 'notify', 'quota_size', 'formatted_used', 'cache_disk', 'cache_path')
    search_fields = ('name', 'email')
    readonly_fields = ('email', 'formatted_used', 'cache_path')
